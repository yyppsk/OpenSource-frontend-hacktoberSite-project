...
!function(e, t) {
    ...
    var we, Me, Pe, Ae, De, Ee, Oe, Ye, ze, t, Xe, Te, ke, o = 1, Ce = [];
    a._scrollers = [],
    a._proxies = [];
    function x(e, t) {
    ...
    function I(t, e) {
        ...
        var c = a._scrollers[o + i]
          , s = c || (a._scrollers[o + i] = E(x(t, n), !0) || (y(t) ? r : E(function(e) {
    ...
    function J(e, t, o) {
        ...
        return {
            ...
            getVelocity: function getVelocity(e) {
                ...
                s === a || l < r - a ? 0 : (i + (o ? n : -n)) / ((o ? r : s) - t) * 1e3
            }
        }
    }
    function K(e, t) {
    ...
    function N(e) {
        return (we = e || r()) && "undefined" != typeof document && document.body && (Pe = window,
        ...
        Oe = s.isTouch = Pe.matchMedia && Pe.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart"in Pe || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints ? 2 : 0,
        Te = s.eventTypes = ("ontouchstart"in De ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown"in De ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(","),
        setTimeout(function() {
            return o = 0
        }, 500),
        M(),
    ...
    var s = (Observer.prototype.init = function init(e) {
        ...
        function rc() {
            ...
            n && (_ && 0 < se.deltaX && _(se),
            m && se.deltaX < 0 && m(se),
            P && P(se),
            Y && se.deltaX < 0 != ae < 0 && Y(se),
            ae = se.deltaX,
            ye[0] = ye[1] = ye[2] = 0),
            r && (w && 0 < se.deltaY && w(se),
            b && se.deltaY < 0 && b(se),
            E && E(se),
        ...
        function tc(e, t) {
            Z && !ce && (se.axis = ce = Math.abs(e) > Math.abs(t) ? "x" : "y",
            ie = !0),
            "y" !== ce && (ye[2] += e,
            se._vx.update(e, !0)),
            "x" !== ce && (xe[2] += t,
        ...
        function uc(e) {
            if (!pc(e, 1)) {
                ...
                se.x = t,
                se.y = n,
                (i || Math.abs(se.startX - t) >= c || Math.abs(se.startY - n) >= c) && (h && (ne = !0),
                i || (se.isDragging = !0),
                tc(r, o),
                i || g && g(se))
            }
        ...
        var ee, te, ne, re, oe, ie, ce, se = this, ae = 0, le = 0, ue = I(i, Se), fe = I(i, He), de = ue(), ge = fe(), pe = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Te[0], he = y(i), ve = i.ownerDocument || Ae, ye = [0, 0, 0], xe = [0, 0, 0], _e = 0, me = se.onPress = function(e) {
            pc(e, 1) || e && e.button || (se.axis = ce = null,
            te.pause(),
            se.isPressed = !0,
            e = K(e),
            ae = le = 0,
                ...
                s && Q && we.delayedCall(.08, function() {
                    if (300 < qe() - _e && !t.defaultPrevented)
                        if (t.target.click)
                            ...
                            e.initMouseEvent("click", !0, !0, Pe, 1, r.screenX, r.screenY, r.clientX, r.clientY, !1, !1, !1, !1, 0, null),
        ...
        se.enable = function(e) {
            return se.isEnabled || (z(he ? ve : i, "scroll", D),
            0 <= t.indexOf("scroll") && z(he ? ve : i, "scroll", zc, s, U),
            0 <= t.indexOf("wheel") && z(i, "wheel", Ac, s, U),
            (0 <= t.indexOf("touch") && Oe || 0 <= t.indexOf("pointer")) && (z(i, Te[0], me, s, U),
            z(ve, Te[2], be),
            z(ve, Te[3], be),
            Q && z(i, "click", oc, !1, !0),
            j && z(i, "click", Ec),
